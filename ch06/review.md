...
> 这道题目的英文原文为:  
 ...
 正确的题目要求是，后5行中使用的是前一行产生的`quack`值！！译者把这道题目翻译错了！！
...
> 本人使用的是人民邮电出版社出版的《C Primer Plus(第6版) 中文版》（姜佑 译），打错字本身不可避免，编辑及录入也可能会存在疏忽，个别错误完全可以容忍。但是，本书中一次又一次地出现低级翻译错误，真的让我开始怀疑译者的真实水平以及出版社的审校能力。  
> 附这本书的出版社[页面链接](http://www.epubit.com.cn/book/details/1848)，截至2016/11/24，勘误列表中印次为5的勘误都是我提出来的
